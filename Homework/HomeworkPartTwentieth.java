...
public class HomeworkPartTwentieth {
    // объявите поле для ссылки на карту (англ. map link)
    public static final String map_link = "https://recyclemap.kz/";
    ...
    public static void main(String[] args) {
        ...
        switch (command) {
            ...
            case RECYCLABILITY:
                ...
                int processing = scanner.nextInt();
                isRecycled(processing);
                break;
            case BONUS:
                ...
                if (weigth < 10) {
                    weigth *= 10;
                    System.out.println("Количество бонусных баллов: " + weigth);
                } else {
                    weigth *= 15;
                    System.out.println("Количество бонусных баллов: " + weigth);
                }
    ...
    protected static final Map<MaterialType, String> getContainers() {
